...
5. [SYNONYMS] section: only include if the input is a single word or short phrase (number of synonyms as max as possible). List synonyms in the ${req.targetLang} language. If input is looks like a sentence, write empty string.
